...
export const productSchema = Yup.object().shape({
	...
	lactose: Yup.string()
		...
		.when("category", {
			...
			then: Yup.string()
				.oneOf(["false", "true"], "You must select if it has Lactose")
				.required("Lactose is required if select Salty backery"),
			otherwise: Yup.string().notRequired()
		})
		.when("category", {
			...
			then: Yup.string()
				.oneOf(["false", "true"], "You must select if it has Lactose")
				.required("Lactose is required if select Sweet backery"),
			otherwise: Yup.string().notRequired()
		})
		.when("category", {
			is: CATEGORIES.TEA_READY_TO_DRINK,
			then: Yup.string()
				.oneOf(["false", "true"], "You must select if it has Lactose")
				.required("Lactose is required if select Tea ready to drink"),
			otherwise: Yup.string().notRequired()
		})
		.when("category", {
			is: CATEGORIES.OTHER,
			then: Yup.string()
				.oneOf(["false", "true"], "You must select if it has Lactose")
				.required("Lactose is required if select Other"),
			otherwise: Yup.string().notRequired()
		}),
	//? //////////////////////////////////////////////////////////////////////////////////
	alcohol: Yup.string()
	...
	//? //////////////////////////////////////////////////////////////////////////////////
	cream: Yup.string().when("category", {
		is: CATEGORIES.COFFEE_READY_TO_DRINK,
		then: Yup.string()
